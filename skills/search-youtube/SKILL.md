...
`C:/Users/cuong/.pi/agent/skills/search-youtube/scripts/yt_research.py`.

Run `python C:/Users/cuong/.pi/agent/skills/search-youtube/scripts/yt_research.py <subcommand> --help`
...
```bash
python C:/Users/cuong/.pi/agent/skills/search-youtube/scripts/yt_research.py search "<query>" --count 10
```
...
```bash
python C:/Users/cuong/.pi/agent/skills/search-youtube/scripts/yt_research.py transcript "<url>"
```
...
```bash
python C:/Users/cuong/.pi/agent/skills/search-youtube/scripts/yt_research.py metadata "<url>"
```
...
```bash
python C:/Users/cuong/.pi/agent/skills/search-youtube/scripts/yt_research.py audio "<url>" --audio-format mp3 -t <topic>
```
...
```bash
python C:/Users/cuong/.pi/agent/skills/search-youtube/scripts/yt_research.py channel "<url-or-@handle>" --limit 20
```
...
```bash
python C:/Users/cuong/.pi/agent/skills/search-youtube/scripts/yt_research.py transcript --batch urls.txt --save -t <topic>
```
...
```bash
python C:/Users/cuong/.pi/agent/skills/search-youtube/scripts/yt_research.py search "<query-variant>" --count 15
```
...
```bash
python C:/Users/cuong/.pi/agent/skills/search-youtube/scripts/yt_research.py channel "<channel-url>" --limit 20
```
...
```bash
python C:/Users/cuong/.pi/agent/skills/search-youtube/scripts/yt_research.py transcript "<url>" --save -t <topic>
```
